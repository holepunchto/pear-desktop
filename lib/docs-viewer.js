...
!(function (e, t) {
      ...
      (n = (function (e, t) {
        ...
        if (e)
          return typeof e === 'string'
            ? s(e, t)
            : (u = (u = Object.prototype.toString.call(e).slice(8, -1)) === 'Object' && e.constructor ? e.constructor.name : u) === 'Map' ||
              u === 'Set'
            ? Array.from(e)
  ...
  function h(e, t, u) {
    ...
    t &&
      ...
      (t = (n = f[' ' + n]).indexOf(':') === -1),
      (u = e.substring(0, 2) === '//' ? (t ? e : n.replace(M, '$1') + e) : e.charAt(0) === '/' ? (t ? e : n.replace(H, '$1') + e) : n + e))
    try {
    ...
    return (
      ...
      (t.code = function (e) {
        ...
        if (e)
          return (
            ...
            { type: 'code', raw: e[0], codeBlockStyle: 'indented', text: this.options.pedantic ? t : A(t, '\n') }
          )
      }),
      (t.fences = function (e) {
        let t
      ...
      (t.list = function (e) {
        ...
        if (t) {
          ...
          const f = { type: 'list', raw: '', ordered: h, start: h ? +g.slice(0, -1) : '', loose: !1, items: [] }
          ...
          for (
            ...
            if (
              ...
              this.options.pedantic
                ? ((i = 2), (c = o.trimLeft()))
                : ((i = t[2].search(/[^ ]/)), (c = o.slice((i = i > 4 ? 1 : i))), (i += t[1].length)),
              (s = !1),
              !o && /^ *$/.test(l) && ((u += l + '\n'), (e = e.substring(l.length + 1)), (p = !0)),
              !p)
            )
              for (
                let d = new RegExp('^ {0,' + Math.min(3, i - 1) + '}(?:[*+-]|\\d{1,9}[.)])((?:[ \t][^\\n]*)?(?:\\n|$))'),
                  k = new RegExp('^ {0,' + Math.min(3, i - 1) + '}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)'),
                  A = new RegExp('^ {0,' + Math.min(3, i - 1) + '}(?:```|~~~)'),
                  C = new RegExp('^ {0,' + Math.min(3, i - 1) + '}#');
                e &&
                ((l = D = e.split('\n', 1)[0]), this.options.pedantic && (l = l.replace(/^ {1,4}(?=( {4})*[^ ])/g, '  ')), !A.test(l)) &&
                !C.test(l) &&
                !d.test(l) &&
                !k.test(e);
        ...
        if (e) {
          ...
          return (
            ...
            C(
              ...
              {
                href:
                  (u = /^</.test(u) ? (this.options.pedantic && !/>$/.test(t) ? u.slice(1) : u.slice(1, -1)) : u) &&
      ...
      (t.emStrong = function (e, t, u) {
        ...
        if (
          ...
          let i = r
          let s = 0
          const a = n[0][0] === '*' ? this.rules.inline.emStrong.rDelimAst : this.rules.inline.emStrong.rDelimUnd
            ...
            if (l)
              if (((l = l.length), n[3] || n[4])) i += l
                ...
                return (
                  ...
                  Math.min(r, l) % 2
                    ? ((l = o.slice(1, -1)), { type: 'em', raw: o, text: l, tokens: this.lexer.inlineTokens(l) })
                    : ((l = o.slice(2, -2)), { type: 'strong', raw: o, text: l, tokens: this.lexer.inlineTokens(l) })
                )
          }
        }
      }),
      ...
      (t.autolink = function (e, t) {
        ...
        if (e)
          return (
            ...
            { type: 'link', raw: e[0], text: u, href: t, tokens: [{ type: 'text', raw: u, text: u }] }
          )
      }),
      (t.url = function (e, t) {
        let u, n, r, i
  ...
  function w(e) {
    for (var t, u = '', n = e.length, r = 0; r < n; r++)
      (t = e.charCodeAt(r)), (u += '&#' + (t = Math.random() > 0.5 ? 'x' + t.toString(16) : t) + ';')
    return u
  }
  ;(b._punctuation = '\\p{P}$+<=>`^|~'),
    ...
    (b.emStrong.rDelimAst = p(b.emStrong.rDelimAst, 'gu').replace(/punct/g, b._punctuation).getRegex()),
    (b.emStrong.rDelimUnd = p(b.emStrong.rDelimUnd, 'gu').replace(/punct/g, b._punctuation).getRegex()),
    ...
    (b._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (b._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (b.link = p(b.link).replace('label', b._label).replace('href', b._href).replace('title', b._title).getRegex()),
    ...
    (b.reflinkSearch = p(b.reflinkSearch, 'g').replace('reflink', b.reflink).replace('nolink', b.nolink).getRegex()),
    (b.normal = g({}, b)),
  ...
  const B = (function () {
    function u(e) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm && ((e.block = m.gfm), this.options.breaks ? (e.inline = b.breaks) : (e.inline = b.gfm)),
    ...
    return (
          ...
          const e = (function () {
            if (
              ...
              D.options.extensions.block.some(function (e) {
                return !!(s = e.call({ lexer: D }, r, i)) && ((r = r.substring(s.raw.length)), i.push(s), !0)
              })
            )
              return 'continue'
            if ((s = D.tokenizer.space(r)))
              return (
                (r = r.substring(s.raw.length)), s.raw.length === 1 && i.length > 0 ? (i[i.length - 1].raw += '\n') : i.push(s), 'continue'
              )
            ...
            if ((s = D.tokenizer.def(r)))
              return (
                (r = r.substring(s.raw.length)),
                !(a = i[i.length - 1]) || (a.type !== 'paragraph' && a.type !== 'text')
                  ? D.tokens.links[s.tag] || (D.tokens.links[s.tag] = { href: s.href, title: s.title })
            ...
            if (
              ...
              D.options.extensions &&
                ...
                D.options.extensions.startBlock.forEach(function (e) {
                  typeof (n = e.call({ lexer: this }, u)) === 'number' && n >= 0 && (t = Math.min(t, n))
                }),
                t < 1 / 0) &&
                t >= 0 &&
                (o = r.substring(0, t + 1)),
      ...
      (n.inlineTokens = function (r, i) {
        ...
        for (; (e = this.tokenizer.rules.inline.anyPunctuation.exec(p)) != null; )
          p = p.slice(0, e.index) + '++' + p.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex)
        for (; r; ) {
          const u = (function () {
            if (
              (l || (D = ''),
              ...
              c.options.extensions &&
                ...
                c.options.extensions.inline.some(function (e) {
                  return !!(s = e.call({ lexer: c }, r, i)) && ((r = r.substring(s.raw.length)), i.push(s), !0)
                }))
            )
              return 'continue'
            ...
            if ((s = c.tokenizer.tag(r)))
              return (
                (r = r.substring(s.raw.length)),
                (a = i[i.length - 1]) && s.type === 'text' && a.type === 'text' ? ((a.raw += s.raw), (a.text += s.text)) : i.push(s),
                'continue'
              )
            ...
            if (
              ...
              return (
                ...
                (l = !0),
                (a = i[i.length - 1]) && a.type === 'text' ? ((a.raw += s.raw), (a.text += s.text)) : i.push(s),
                'continue'
              )
            if (r) {
              const e = 'Infinite loop on byte: ' + r.charCodeAt(0)
  ...
  const y = (function () {
    ...
    return (
      (t.code = function (e, t, u) {
        ...
        var t = (t || '').match(/\S*/)[0]
        return (
          this.options.highlight && (n = this.options.highlight(e, t)) != null && n !== e && ((u = !0), (e = n)),
          (e = e.replace(/\n$/, '') + '\n'),
          t
            ? '<pre><code class="' + this.options.langPrefix + D(t) + '">' + (u ? e : D(e, !0)) + '</code></pre>\n'
      ...
      (t.heading = function (e, t, u, n) {
        return this.options.headerIds
          ? '<h' + t + ' id="' + (this.options.headerPrefix + n.slug(u)) + '">' + e + '</h' + t + '>\n'
          : '<h' + t + '>' + e + '</h' + t + '>\n'
      }),
      (t.hr = function () {
      ...
      (t.image = function (e, t, u) {
        return (e = h(this.options.sanitize, this.options.baseUrl, e)) === null
          ? u
          : ((e = '<img src="' + e + '" alt="' + u + '"'), t && (e += ' title="' + t + '"'), e + (this.options.xhtml ? '/>' : '>'))
      }),
      (t.text = function (e) {
        return e
      }),
  ...
  const z = (function () {
    ...
    return (
      (e.parse = function (e, t) {
        void 0 === t && (t = !0)
        for (var u, n, r, i, s, a, o, l, D, c, p, h, f, g, F, d, k = '', A = e.length, C = 0; C < A; C++)
          if (
            ((l = e[C]),
            this.options.extensions &&
              ...
              (!1 !== (d = this.options.extensions.renderers[l.type].call({ parser: this }, l)) ||
                !['space', 'hr', 'heading', 'code', 'table', 'blockquote', 'list', 'html', 'paragraph', 'text'].includes(l.type)))
          )
            k += d || ''
          else
            switch (l.type) {
              ...
              case 'table':
                for (a = D = '', r = l.header.length, u = 0; u < r; u++)
                  a += this.renderer.tablecell(this.parseInline(l.header[u].tokens), { header: !0, align: l.align[u] })
                for (D += this.renderer.tablerow(a), o = '', r = l.rows.length, u = 0; u < r; u++) {
                  for (a = '', i = (s = l.rows[u]).length, n = 0; n < i; n++)
                    a += this.renderer.tablecell(this.parseInline(s[n].tokens), { header: !1, align: l.align[n] })
              ...
              case 'blockquote':
                ...
                continue
              case 'list':
                for (D = l.ordered, E = l.start, c = l.loose, r = l.items.length, o = '', u = 0; u < r; u++)
              ...
              case 'paragraph':
                ...
                continue
              case 'text':
                for (o = l.tokens ? this.parseInline(l.tokens) : l.text; C + 1 < A && e[C + 1].type === 'text'; )
          ...
          if (
            ...
            this.options.extensions &&
              ...
              (!1 !== (n = this.options.extensions.renderers[u.type].call({ parser: this }, u)) ||
                !['escape', 'html', 'link', 'image', 'strong', 'em', 'codespan', 'br', 'del', 'text'].includes(u.type)))
          )
            r += n || ''
          else
            switch (u.type) {
  ...
  var d = (function () {
    ...
    return (
          ...
          !(function () {
            ...
            switch (((D = D.concat(a.call(l, t))), t.type)) {
              ...
              case 'list':
                ...
                break
              default:
                l.defaults.extensions && l.defaults.extensions.childTokens && l.defaults.extensions.childTokens[t.type]
      ...
      (t.use = function () {
        for (
          var D = this, c = this.defaults.extensions || { renderers: {}, childTokens: {} }, e = arguments.length, t = new Array(e), u = 0;
          u < e;
          u++
        )
          t[u] = arguments[u]
                    ...
                    c[r.level] ? c[r.level].unshift(r.tokenizer) : (c[r.level] = [r.tokenizer]),
                      r.start &&
                        (r.level === 'block'
                          ...
                          : r.level === 'inline' && (c.startInline ? c.startInline.push(r.start) : (c.startInline = [r.start])))
                  }
                  ...
                  u.type === 'code' &&
                    ...
                    setTimeout(function () {
                      a(u.text, u.lang, function (e, t) {
                        if (e) return l(e)
                        t != null && t !== u.text && ((u.text = t), (u.escaped = !0)), --o === 0 && l()
                      })
                    }, 0))
                }),
                void (o === 0 && l()))
  ...
  function G(u, n, r) {
    return function (e) {
      ...
      if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), u))
        return (t = '<p>An error occurred:</p><pre>' + D(e.message + '', !0) + '</pre>'), n ? Promise.resolve(t) : r ? void r(null, t) : t
...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    patchSyntax (input) {
      ...
      output = output.replace(/(?<!((vendor\/pear-docs)|(\.\.)))\/howto/g, '/vendor/pear-docs/howto')
      output = output.replace(/(?<!((vendor\/pear-docs)|(\.\.)))\/reference/g, '/vendor/pear-docs/reference')
      output = output.replace(/(?<!((vendor\/pear-docs)|(\.\.)))\/tools/g, '/vendor/pear-docs/tools')
      output = output.replace(/(?<!((vendor\/pear-docs)|(\.\.)))\/apps/g, '/vendor/pear-docs/apps')
      output = output.replace(/(?<!((vendor\/pear-docs)|(\.\.)))\/examples/g, '/vendor/pear-docs/examples')
      output = output.replace(/(?<!((vendor\/pear-docs)|(\.\.)))\/bare-reference/g, '/vendor/pear-docs/bare-reference')
      output = output.replace(/(\.\/assets)|(\.\.\/assets)/g, '/vendor/pear-docs/assets')
