      ...
      <div>
        ...
        <div>
          ...
          <div class="panels-wrapper">
            ...
            <p>You can drop data of your applications via CLI:</p>
            <pre><code>pear drop app pear://$KEY</code></pre>
            <p>Or use this page to do it for you.</p>
            <p>Dropping the data means "factory resetting" the app and deleting all personal data stored by the app in the process.</p>
            
            <h3>Select the apps for which you want to drop the data:</h3>
